...
(hold-chest-to-put-on-floor 0
  ...
  (monkey holding ?thing
         ((not= ?thing ?chest)
          (not-exists goal-is-to action hold argument1 ?chest)))
  =>
...
(get-key-to-unlock 0
  ...
  (monkey holding ?thing
          ((not= ?thing ?key)
           (not-exists goal-is-to action hold argument1 ?key)))
  =>
...
(move-to-chest-with-key 0
  ...
  (chest name ?chest unlocked-by ?key
         (not-exists goal-is-to action walk-to argument1 ?cplace))
  =>
...
(unlock-chest-to-hold-object 0
  ...
  (chest name ?chest contents ?obj
         (not-exists goal-is-to action unlock argument1 ?chest))
  =>
...
(use-ladder-to-hold 0
  ...
  (thing name ?obj location ?place on-top-of ceiling weight light
         ((not-exists thing name ladder location ?place)
          (not-exists goal-is-to action move argument1 ladder argument2 ?place)))
  =>
...
(climb-ladder-to-hold 0
  ...
  (monkey on-top-of ?s
          ((not= ?s ladder)
           (not-exists goal-is-to action on argument1 ladder)))
  =>
...
(climb-to-hold 0
  ...
  (monkey location ?place on-top-of ?surf
          ((not= ?surf ?on)
           (not-exists goal-is-to action on argument1 ?on)))
  =>
...
(walk-to-hold 0
  ...
  (monkey location ?loc
          ((not= ?loc ?place)
           (not-exists goal-is-to action walk-to argument1 ?place)))
  =>
...
(drop-to-hold 0
  ...
  (monkey location ?place on-top-of ?on holding ?hold
          ((not= ?hold blank)
           (not-exists goal-is-to action hold argument1 blank)))
  =>
...
(hold-object-to-move 0
  ...
  (monkey holding ?hold
          ((not= ?hold ?obj)
           (not-exists goal-is-to action hold argument1 ?obj)))
  =>
...
(get-on-floor-to-walk 0
  ...
  (monkey location ?loc on-top-of ?surf
          ((not= ?loc ?place)
           (not= ?surf floor)
           (not-exists goal-is-to action on argument1 floor)))
  =>
